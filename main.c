...
int main()
{
	printf("    ________        __ __        ______                      __            \n   /  _/ __ \\_   __/ // /       / ____/_  ________________ _/ /_____  _____\n   / // /_/ / | / / // /_______/ /_  / / / / ___/ ___/ __ `/ __/ __ \\/ ___/\n _/ // ____/| |/ /__  __/_____/ __/ / /_/ (__  ) /__/ /_/ / /_/ /_/ / /    \n/___/_/     |___/  /_/       /_/    \__,_/____/\\___/\\__,_/\\__/\\____/_/     \n                                                                           \n");
	printf("Payload Obfuscation Tool for Security Testing - sizeof(payload) must be a multiple of 4 - edit in source\n");

	unsigned char unobf_payload[] = {
	...
	if (!GenerateIpv4Output(unobf_payload, sizeof(unobf_payload))) {
		return -1;
	}
